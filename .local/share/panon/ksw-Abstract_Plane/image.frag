#version 130
// property Image iChannel3: Image { source: "./Shadertoy_Organic_3.jpg" }
// from Shane
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
	...
	*/
	...
	if(t < FAR){
	    ...
	    sn = texBump(iChannel3, sp*tSize0, sn, 0.01);
        ...
        //vec3 rfCol = texture(iChannel3, reflect(rd, sn)).xyz; // Forest scene.
