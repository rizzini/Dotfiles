...
complete -c ebtables -s t -d 'CONTINUE means the next rule has to be checked.  This can be handy, f. e'
complete -c ebtables -l table
complete -c ebtables -s L -s Z -d 'are combined, the commands'
complete -c ebtables -s N -s P -d 'are combined, or when'
complete -c ebtables -l atomic-file -d 'is used'
...
complete -c ebtables -l atomic-init -d 'Copy the kernel\'s initial data of the table to the specified file'
complete -c ebtables -l atomic-save -d 'Copy the kernel\'s current data of the table to the specified file'
complete -c ebtables -l atomic-commit -d 'Replace the kernel table data with the data contained in the specified file'
