#version 130
// property Image iChannel3: Image { source: "./Shadertoy_Rusty_Metal.jpg" }
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
	...
	sn = doBumpMap(iChannel3, sp*tSize0, sn, 0.002);
   ...
   // Obtaining the surface texel, then ramping up the contrast a bit.
    vec3 oC = smoothstep(0., 1., tex3D(iChannel3, sp*tSize0, sn));
