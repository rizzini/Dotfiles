...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    sceneColor = pow(sceneColor, vec3(1.)) * 0.6; // (iChannelTime[0] > 0. ? texelFetch(iChannel3, ivec2(128, 0), 0).r * min(1., mt * .1) : 0.6);
    ...
    steamColor1 *= 1. ; //iChannelTime[0] > 0. ? texelFetch(iChannel3, ivec2(32, 0), 0).r : 1.;
