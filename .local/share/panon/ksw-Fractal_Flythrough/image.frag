...
// property Image iChannel3: Image { source: "./Shader_Fractal_Flythrough_iChannel3.png" }
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
    ...
    if(t<FAR){
        ...
        nor = texBump(iChannel3, pos*ts, nor, 0.002); // + step(saveObjID, 1.5)*0.002
        ...
        col = tex3D(iChannel3, pos*ts, nor); // Texture pixel at the scene postion.
        ...
        vec3 rCol = tex3D(iChannel3, rsp*ts, rsn); // Texel at rsp.
        vec3 rLi = lp-rsp;
