...
// property Image iChannel3: Image { source: "./Shadertoy_RGBA_Noise_Small.png" }
...
void mainImage (out vec4 fragColor, in vec2 fragCoord) {
	...
	// Get the music info
	#ifdef SOUND
	float soundBass = texture (iChannel3, vec2 (0.0)).x;
	float soundTreble = texture (iChannel3, vec2 (0.9, 0.0)).x;
	#else
